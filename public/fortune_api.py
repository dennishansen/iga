#!/usr/bin/env python3
"""
Fortune API - A simple endpoint that returns Iga-style wisdom
Can be deployed as a serverless function or Flask route
"""
...
if __name__ == "__main__":
    print(json.dumps(get_fortune(), indent=2))
